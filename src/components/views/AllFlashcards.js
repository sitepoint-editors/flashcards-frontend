...
const DELETE_FLASHCARD_QUERY = gql`
...
const AllFlashcards = () => {
  ...
  const [deleteFlashcard] = useMutation(DELETE_FLASHCARD_QUERY, {
    update(
      cache,
      {
  ...
  return (
    <div className="container mt-3">
      <h1 className="title">All Flashcards
        <button className="button is-info is-light ml-3" onClick={ () => {
          data.allFlashcards.map( function(flashcard) { 
